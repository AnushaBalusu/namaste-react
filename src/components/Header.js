        ...
        <div className="flex justify-between shadow-lg mb-2 ">
            ...
            <div className="flex items-center">
                <ul className="flex p-4 m-4">
                    ...
                    <li className="px-4 py-2 hover:bg-slate-100 rounded-lg"><Link to="/">Home</Link></li>
                    ...
                    <li className="px-4 py-2 hover:bg-slate-100 rounded-lg"><Link to="/cart">Cart ({cartItems.length})</Link></li>
                    <button className="login" onClick={()=> { loginBtn === "Login" ? setLoginBtn("Logout") : setLoginBtn("Login")}}>{loginBtn}</button>
                    <li className="px-4 py-2 font-bold">{loggedInUser}</li>
                </ul>
            </div>
        </div>
    )
